...
#
# These files are auto-generated by scripts/agent_docs/build_agent_docs.py from
...
if echo "$staged_files" | grep -qE "(docs/AGENTS\.src\.md|scripts/agent_docs/build_agent_docs\.py)"; then
    exit 0
fi
